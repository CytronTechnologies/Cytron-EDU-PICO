...
def run_module(duration, oled):
    ...
    if time.monotonic() > interval:
        ...
        oled.text("Color Temp: {:.2f}".format(colorutility.calculate_color_temperature(r, g, b)), 3, 20, 1)
        oled.text("Light Lux: {:.2f}".format(colorutility.calculate_lux(r, g, b)), 10, 35, 1)
